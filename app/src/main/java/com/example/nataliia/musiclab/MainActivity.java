...
public class MainActivity extends AppCompatActivity {
    ...
    public void player(int[] dur){
        for(int i = 0; i < dur.length; i++){
            Log.d("IiI", Integer.toString(dur.length));
            tg.startTone(duration_const[dur[i]], 500);
        }
    }
